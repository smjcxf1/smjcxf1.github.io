...
$.ajax({
  ...
  data: {
    key: 'DNDBZ-RSLWI-PBGGM-U467H-ZHHGJ-MLBBU',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
//
  //根据国家、省份、城市信息自定义欢迎语
  //这里换成自己的经纬度113.34499552,23.15537143
function showWelcome() {
	let e, t, n, o = getDistance(117.23145,39.25589, ipLoacation.result.location.lng, ipLoacation.result.location.lat),
	...
	switch (ipLoacation.result.ad_info.nation) {
		...
		case "加拿大":
			...
			break;
		case "中国":
			switch (a = ipLoacation.result.ad_info.province + " " + ipLoacation.result.ad_info.city + " " + ipLoacation.result.ad_info.district, e = ipLoacation.result.ip, ipLoacation.result.ad_info.province) {
				case "北京市":
					t = "北——京——欢迎你~~~";
					break;
				case "天津市":
...
function createtime() {
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign' src='/badge/F小屋-科研摸鱼中.svg' title='什么时候能够实现财富自由呀~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<img class='boardsign' src='/badge/F小屋-下班休息啦.svg' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
// 博天
let seovx = "url(https://api.btstu.cn/doc/sjbz.php)";
// picsum随机
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(/imgs/home_bg.webp);
    --darkmode-bg:url(/imgs/fj/fj5.webp);
    --mobileday-bg: url(/imgs/sj/sj1.webp);
    --mobilenight-bg: url(/imgs/sj/sj3.webp);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/dm/dm1.webp)" class="imgbox" onclick="changeBg('url(/imgs/dm/dm1.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/dm/dm2.webp)" class="imgbox" onclick="changeBg('url(/imgs/dm/dm2.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/dm/dm3.webp)" class="imgbox" onclick="changeBg('url(/imgs/dm/dm3.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/dm/dm4.webp)" class="imgbox" onclick="changeBg('url(/imgs/dm/dm4.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/dm/dm5.webp)" class="imgbox" onclick="changeBg('url(/imgs/dm/dm5.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/dm/dm6.webp)" class="imgbox" onclick="changeBg('url(/imgs/dm/dm6.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/dm/dm7.webp)" class="imgbox" onclick="changeBg('url(/imgs/dm/dm7.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/dm/dm8.webp)" class="imgbox" onclick="changeBg('url(/imgs/dm/dm8.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看风景背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/fj/fj1.webp)" class="imgbox" onclick="changeBg('url(/imgs/fj/fj1.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/fj/fj2.webp)" class="imgbox" onclick="changeBg('url(/imgs/fj/fj2.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/fj/fj3.webp)" class="imgbox" onclick="changeBg('url(/imgs/fj/fj4.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/fj/fj4.webp)" class="imgbox" onclick="changeBg('url(/imgs/fj/fj3.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/fj/fj5.webp)" class="imgbox" onclick="changeBg('url(/imgs/fj/fj5.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/fj/fj6.webp)" class="imgbox" onclick="changeBg('url(/imgs/fj/fj6.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/fj/fj7.webp)" class="imgbox" onclick="changeBg('url(/imgs/fj/fj7.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/fj/fj8.webp)" class="imgbox" onclick="changeBg('url(/imgs/fj/fj8.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看萌宠背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/mc/mc1.webp)" class="imgbox" onclick="changeBg('url(/imgs/mc/mc1.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/mc/mc2.webp)" class="imgbox" onclick="changeBg('url(/imgs/mc/mc2.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/mc/mc3.webp)" class="imgbox" onclick="changeBg('url(/imgs/mc/mc3.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/mc/mc4.webp)" class="imgbox" onclick="changeBg('url(/imgs/mc/mc4.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/mc/mc5.webp)" class="imgbox" onclick="changeBg('url(/imgs/mc/mc5.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/mc/mc6.webp)" class="imgbox" onclick="changeBg('url(/imgs/mc/mc6.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/mc/mc7.webp)" class="imgbox" onclick="changeBg('url(/imgs/mc/mc7.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/mc/mc8.webp)" class="imgbox" onclick="changeBg('url(/imgs/mc/mc8.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/sj/sj1.webp)" class="imgbox" onclick="changeBg('url(/imgs/sj/sj1.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/sj/sj2.webp)" class="imgbox" onclick="changeBg('url(/imgs/sj/sj2.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/sj/sj3.webp)" class="imgbox" onclick="changeBg('url(/imgs/sj/sj3.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/sj/sj4.webp)" class="imgbox" onclick="changeBg('url(/imgs/sj/sj4.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/sj/sj5.webp)" class="imgbox" onclick="changeBg('url(/imgs/sj/sj5.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/sj/sj6.webp)" class="imgbox" onclick="changeBg('url(/imgs/sj/sj6.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/sj/sj7.webp)" class="imgbox" onclick="changeBg('url(/imgs/sj/sj7.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/imgs/sj/sj8.webp)" class="imgbox" onclick="changeBg('url(/imgs/sj/sj8.webp)')"></a></div>
              </div>
            </details>
